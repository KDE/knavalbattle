...
public:
    ...
    void setDrawField(bool draw)
    {
        m_canDraw = draw;
    }

    void setOwnState(int fieldx, int fieldy, int type)
    {
        m_ownfield[fieldx][fieldy] = type;
    }
    int ownState(int fieldx, int fieldy)
    {
        return m_ownfield[fieldx][fieldy];
    }

    void setEnemyState(int fieldx, int fieldy, int type)
    {
        m_enemyfield[fieldx][fieldy] = type;
    }
    int enemyState(int fieldx, int fieldy)
    {
        return m_enemyfield[fieldx][fieldy];
    }
